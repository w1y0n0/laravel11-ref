                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            ...
                            <canvas id="myAreaChart" width="481" height="160"
                                style="display: block; width: 481px; height: 160px;"
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-pie pt-4 pb-2">
                            ...
                            <canvas id="myPieChart" width="481" height="208"
                                style="display: block; width: 481px; height: 208px;"
                                class="chartjs-render-monitor"></canvas>
                        </div>
